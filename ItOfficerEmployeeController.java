 ...
 * @author HP
 */
public class ItOfficerEmployeeController implements Initializable {
   ...
   private TableView<Person> tableView;
    ...
    @FXML
    private void firstNameMouseOnClick(MouseEvent event) {
         firstNameTextField.setText(null);
    }

    @FXML
    private void lastNameMouseOnClick(MouseEvent event) {
        lastNameTextField.setText(null);
        
    }

    @FXML
    private void userIdMouseOnClick(MouseEvent event) {
        userIdTextField.setText(null);
    }

    @FXML
    private void salaryMouseOnClick(MouseEvent event) {
    ...
    private void saveButtonOnClick(ActionEvent event) {
        ...
        if(isTextFileChkBox.isSelected()){
            ...
            try {
                ...
                //use FileWriter
                File f = new File("ItOfficerEmployee.txt");
                FileWriter fw;
    ...
    private void readTextFileButtonOnClick(ActionEvent event) {
          File file = new File("ItOfficerEmployee.txt");
